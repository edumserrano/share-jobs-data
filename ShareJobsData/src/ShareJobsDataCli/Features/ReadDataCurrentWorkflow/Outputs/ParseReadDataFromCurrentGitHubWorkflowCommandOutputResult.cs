using static ShareJobsDataCli.Features.ReadDataCurrentWorkflow.Outputs.ReadDataFromCurrentGitHubWorkflowCommandOutput;

namespace ShareJobsDataCli.Features.ReadDataCurrentWorkflow.Outputs;
