using static ShareJobsDataCli.Features.ReadDataDifferentWorkflow.Outputs.ReadDataFromDifferentGitHubWorkflowCommandOutput;

namespace ShareJobsDataCli.Features.ReadDataDifferentWorkflow.Outputs;
