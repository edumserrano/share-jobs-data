...
- the docker image tag for `docker://ghcr.io/edumserrano/share-jobs-data` in the [action.yml](/action.yml) file needs to be updated to a new major version if a new major version has been published.
